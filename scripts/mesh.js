    ...
    function Mesh(gl) {
      ...
      this.loadTex = function(filename) {
        ...
        img.onload = function() {
          ...
          gl.pixelStorei(gl.UNPACK_FLIP_Y_UTILS, true);
      ...
      this.initMesh = function(mesh) {
        ...
        if (mesh.vertexNormals) {
          ...
          gl.bufferData(gl.ARRAY_BUFFER, 
                        new Float32Array(mesh.vertexNormals), gl.STATIC_DRAW);
        }
        ...
        for (var m in mesh.materials) {
          ...
          var prog = utils.loadProgram(gl, material.vertexshader, material.fragmentshader, 
                                       function(prog) {
      ...
      this.build = function(mesh, callback) {
        this.callback = callback;
        this.initMesh(mesh);
      };
